...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'master']) &lt;= 1">extension with URL = 'master': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'expected']) &lt;= 1">extension with URL = 'expected': maximum cardinality of 'extension' is 1</sch:assert>
