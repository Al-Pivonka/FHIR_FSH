...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'http://science37.com/fhir/StructureDefinition/force-form-order']) &gt;= 1">extension with URL = 'http://science37.com/fhir/StructureDefinition/force-form-order': minimum cardinality of 'extension' is 1</sch:assert>
